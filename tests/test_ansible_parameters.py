...
class TestParameters(TestCase):
    ...
    def test_any(self):
        ...
        for value in (None, "string", 123, 0o123, [1, 2, 3], {"a": "b"}):
            ...
            self.assertEqual(list(p.list_role_vars(self.role)), [])
    ...
    def test_templated_string_list(self):
        ...
        self.assertEqual(set(p.list_role_vars(self.role)), {"b"})
    ...
    def test_var_reference_string_list(self):
        ...
        self.assertEqual(set(p.list_role_vars(self.role)), {"varname"})
    ...
    def test_template_path(self):
        ...
        self.assertEqual(set(p.list_role_vars(self.role)), None)  # TODO
